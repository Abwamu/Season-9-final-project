...
const Header = ({ transparent = false }) => {
  ...
  const buttonClasses = transparent
    ? "bg-white/30 text-white px-6 py-2 rounded-full hover:bg-white/40 transition-all duration-300"
    : "bg-gradient-to-r from-[#89CFF0] to-[#5BA3C7] text-white px-6 py-2 rounded-full hover:shadow-lg transition-all duration-300";
